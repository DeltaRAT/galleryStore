                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="/{{ $product->thumbnail_url }}" alt="" height="100px" width="100px">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <img src="/{{ $product->demo_url }}" alt="" height="100px" width="100px">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('admin.products.download.source', $product->id) }}" class="btn btn-default btn-icons" title="سورس اصلی محصول">لینک دانلود </a>
                                            </div>
                                        </div>
